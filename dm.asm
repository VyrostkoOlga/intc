...
s:
	...
	convert: ; Выводим на экран из counter в video_buff_addr:0..
             ; Т.е эта функция не поддерживает вывод в разные страницы !
	         ; Конвертируя из 16-ичной в двоичную
	         ; В текущей программе не используется
	    push ax
        push bx
        push dx
        push cx
